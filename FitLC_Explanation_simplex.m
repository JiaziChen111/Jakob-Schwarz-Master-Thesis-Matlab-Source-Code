function [a_x,b_x,k_t,y_x,fval,exitflag]=FitLC_Explanation_simplex(lnM,g_t, a_start, b_start, k_start,y_start,W,norming)
...
options = optimset('MaxFunEvals',24000,'MaxIter',12000, 'TolFun',1e-10,'TolX',1e-10);
