...
hold on
plot(linspace(1,x_cut-1 ,x_cut ),a_x{12}(1:x_cut),'g');
title('a_x');
...
hold on;
plot(linspace(1,x_cut-1 ,x_cut ),b_x{12}(1:x_cut,1 ),'g');
%legend({'wLC-renormed_{full}','1-0-wLC_{classic}','ML-newton(1)_{eco}','wLC-renormed_{eco}'},'location','best');
legend({'wLC-renormed_{full}','ML-newton(1)_{eco}','wLC-renormed_{eco}','ML-newton(2)_{full}'},'location','best');
...
hold on;
plot(linspace(t+1,t+t_future ,t_future),k_future{12,9},'g--');
...
hold on;
plot(linspace(1,x_cut-1 ,x_cut ),y_x{12}(1:x_cut,1 ),'g');
title('y^{(1)}_x');
...
hold on
plot(linspace(1,x_cut-1 ,x_cut ),y_x{12}(1:x_cut,2 ),'g');
title('y^{(2)}_x');
...
hold on
plot(linspace(1,x_cut-1 ,x_cut ),y_x{12}(1:x_cut,3 ),'g');
title('y^{(3)}_x');
