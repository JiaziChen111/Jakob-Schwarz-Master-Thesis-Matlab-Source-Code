...
hhh=figure;
subplot(2,2,1);
plot(linspace(1,x,x),a_ex_newton2(1:x),'k');
hold on;
plot(linspace(1,x,x),a_ex_newton(1:x),'r');
hold on;
plot(linspace(1,x,x),a_ML_newton(1:x),'c');
hold on;
plot(linspace(1,x,x),a_ML(1:x),'b');
hold on;
plot(linspace(1,x,x),a_2step(1:x),'y');
hold on;
%plot(linspace(1,x,x),a_normalen(1:x),'g');

title('a_x');

subplot(2,2,2);
plot(linspace(1,x,x),b_ex_newton2(1:x),'k');
hold on;
plot(linspace(1,x,x),b_ex_newton(1:x),'r');
hold on;
plot(linspace(1,x,x),b_ML_newton(1:x),'c');
hold on;
plot(linspace(1,x,x),b_ML(1:x),'b');
hold on;
plot(linspace(1,x,x),b_2step(1:x),'y');
hold on;
%plot(linspace(1,x,x),b_normalen(1:x),'g');
...
hold on;
plot(linspace(1,t,t),k_ML_newton(1:t),'c');
hold on;
...
subplot(2,1,2);
plot(linspace(1,x,x),y_ex_newton2(1:x),'k');
hold on;
plot(linspace(1,x,x),y_ex_newton(1:x),'r');
hold on;
plot(linspace(1,x,x),y_ML_newton(1:x),'c');
hold on;
plot(linspace(1,x,x),y_ML(1:x),'b');
hold on;
plot(linspace(1,x,x),y_2step(1:x),'y');
hold on;
%plot(linspace(1,x,x),y_normalen(1:x),'g');
